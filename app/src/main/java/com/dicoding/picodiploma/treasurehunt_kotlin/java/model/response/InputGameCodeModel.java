...
public class InputGameCodeModel {
    ...
    public InputGameCodeModel(Boolean isSuccess, Integer responseCode, String responseMessage, String message, DataJoinGame data) {
